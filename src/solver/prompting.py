...
def build_prompt(
    ...
    header = (
        ...
        "Dense segments are MANDATORY: target 2-10 second segments whenever the video supports it. Segments MUST NEVER exceed 20.0 seconds.\n"
        "MANDATORY SPLIT RULE: If any action or pause exceeds 20 seconds, you MUST split it into multiple smaller sub-segments of 2-10 seconds each.\n"
        "Do not merge for convenience; merge only when segments are truly redundant and the merged result STRICTLY follows the 20-second standard.\n"
